                            ...
                            @foreach($guests as $g)
                                <tr class="border-b">
                                    ...
                                    <td class="p-2 flex gap-2">
                                        <a href="{{ route('admin.guests.show', $g) }}" class="underline">Lihat</a>
                                        <a href="{{ route('admin.guests.edit', $g) }}" class="underline">Edit</a>
                                        <form method="POST" action="{{ route('admin.guests.destroy', $g) }}"
